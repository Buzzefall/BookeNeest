...
using BookeNest.Web.Models;

namespace BookeNest.Web.Controllers
{
    [Authorize]
    public class ManageController : Controller
    {
        private BookeNestSignInManager _signInManager;
        private BookeNestUserManager _userManager;

        public ManageController()
        {
        }

        public ManageController(BookeNestUserManager userManager, BookeNestSignInManager signInManager)
        {
            UserManager = userManager;
            SignInManager = signInManager;
        }

        public BookeNestSignInManager SignInManager
        {
            get
            {
                return _signInManager ?? HttpContext.GetOwinContext().Get<BookeNestSignInManager>();
            }
            private set 
            { 
        ...
        public BookeNestUserManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<BookeNestUserManager>();
            }
            private set
            {
                _userManager = value;

...
using BookeNest.Data.DB.Maps;

using System;
using System.Data.Entity;
using Microsoft.AspNet.Identity.EntityFramework;

namespace BookeNest.Data.DB.Context
{
    public class BookeNestDbContext : IdentityDbContext<User, Role, Guid, UserLogin, UserRole, UserClaim>
    {
        ...
        public static BookeNestDbContext Create() => new BookeNestDbContext();

        public BookeNestDbContext() : base("BookeNestDbConnection")
        {

...
namespace BookeNeest.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(BookeNeestUserManager userManager, BookeNeestSignInManager signInManager)
        {
        ...
        {
            get => _signInManager ?? HttpContext.GetOwinContext().Get<BookeNeestSignInManager>();

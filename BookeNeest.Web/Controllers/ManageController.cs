...
namespace BookeNeest.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(BookeNeestUserManager userManager, BookeNeestSignInManager signInManager)
        {
            UserManager = userManager;
            SignInManager = signInManager;
        }

        public BookeNeestSignInManager SignInManager
        {
            get
            {
                return _signInManager ?? HttpContext.GetOwinContext().Get<BookeNeestSignInManager>();
            }
            private set 
            { 
        ...
        public BookeNeestUserManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<BookeNeestUserManager>();
            }
            private set
            {
                _userManager = value;
